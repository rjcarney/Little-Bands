...
public class SFB_AudioClipArrayCombiner : MonoBehaviour
{
    ...
    public void SaveNow()
    {
        ...
        var filename1 = "Axe_On_Flesh_Axe_1";
        var filename2 = "Axe_On_Flesh_Axe_2";
        var filename3 = "Axe_On_Flesh_Flesh_1";
        var filename4 = "Axe_On_Flesh_Flesh_2";
        var filename5 = "Axe_On_Flesh_Flesh_3";
